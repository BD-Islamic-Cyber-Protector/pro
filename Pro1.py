...
def menu():
  ...
  print('[•] Birthday : '+tl)
  print('──────────────────────────────────────────')
  print('[1] Crack ID Friends')
  print('[2] Crack ID Public')
  print('[3] Crack ID Followers')
  print('[4] Crack ID Like')
  print('[5] IDS Crack')
  print('[0] Exit & logout Token/Cookies')
  print('──────────────────────────────────────────')
  mn=raw_input("[?] Input : ")
  if mn=="":
...
class crack1:
	def __init__(self):
		...
		while True:
			print('──────────────────────────────────────────')
			f=raw_input("[?] Cloning Pass Manual (y/t) : ")
			if f=="":continue
			elif f=="y":
				try:
					while True:
